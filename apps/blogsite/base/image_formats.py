...
register_image_format(Format('left', _('Left-aligned'), 'float-md-start rounded img-fluid', 'width-500'))
register_image_format(Format('right', _('Right-aligned'), 'float-md-end rounded img-fluid', 'width-500'))
